...
class Tribe__Events__Pro__Supports__WPML__Recurring_Event_Creation_Handler implements Tribe__Events__Pro__Supports__WPML__Handler_Interface {
	...
	/**
	 * Tribe__Events__Pro__Supports__WPML__Recurring_Event_Creation_Handler constructor.
	 *
	 * @param Tribe__Events__Pro__Supports__WPML__Event_Listener $event_listener
	 * @param Tribe__Events__Pro__Supports__WPML__WPML           $wpml
	 */
	public function __construct( Tribe__Events__Pro__Supports__WPML__Event_Listener $event_listener, Tribe__Events__Pro__Supports__WPML__WPML $wpml ) {
